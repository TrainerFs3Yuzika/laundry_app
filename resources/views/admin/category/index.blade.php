...
@section('title', 'Categories | Laundry App')
            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td class="border-b">
                            <div class="font-medium whitespace-no-wrap">{{ $category->name_category }}</div>
                        </td>
                        <td class="border-b">
                            <div class="font-medium whitespace-no-wrap text-center">{{ $category->description }}</div>
                        </td>
                        <td class="border-b w-5">
                            <div class="flex sm:justify-center items-center">
                                <a class="flex items-center mr-3 edit-btn" data-id="{{ $category->id }}"
                                    href="javascript:;">
                                    <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit
                                </a>
                                <a class="flex items-center text-theme-6 delete-btn" data-id="{{ $category->id }}"
                                    href="javascript:;">
